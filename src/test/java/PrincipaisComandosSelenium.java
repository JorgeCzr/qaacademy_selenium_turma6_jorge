...
public class PrincipaisComandosSelenium {
    ...
    public void enviarTextosParaTela() {
        ...
        driver.findElement(By.xpath("//textarea[@id='textarea_comp-k37gdirc']")).sendKeys("Please disregard this email as it is just a Selenium automation test that we are learning in class");
